...
<img src={`${import.meta.env.BASE_URL}/images/the-end.png`} loading='eager' alt='The end.' width='1367' height='331' style='max-width: 600px; margin: 30px auto; margin-bottom: 150px;' />
...
<img src={`${import.meta.env.BASE_URL}/images/cpu-pleading-face.png`} loading='lazy' alt='A CPU with an adorable pleading face.' width='280' height='280' style='max-width: 120px; margin: 0 auto;' />
