...
<img src={`${import.meta.env.BASE_URL}/images/init-process-tree.png`} loading='eager' style='max-width: 580px; margin: 0 auto;' alt='A tree of processes. The root node is labeled "init." All child nodes are unlabeled but implied to be spawned by the init process.' width='1400' height='752' />
